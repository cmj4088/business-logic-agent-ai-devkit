...
- **backend**: 存放后端代码，按功能模块划分子目录（routes/services/models/utils）；每个 API 需写注释含功能描述、请求参数、返回值
- **frontend**: 存放前端代码，按功能模块划分子目录（components/pages/hooks/utils/api/styles）
